...
var _user$project$Types$No = {ctor: 'No'};
...
var _user$project$View$textStyle = function (fontSize) {
	return _elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$View$validityColor = function (validity) {
	var _p0 = validity;
	switch (_p0.ctor) {
		case 'Yes':
			return _user$project$View$validColor;
		case 'No':
			return _user$project$View$invalidColor;
		default:
			return _user$project$View$partialColor;
	}
};
...
var _user$project$View$partialPath = '../UI/Image/md_indeterminate_check_box_orange_24dp_1x.png';
var _user$project$View$invalidPath = '../UI/Image/md_indeterminate_check_box_red_24dp_1x.png';
var _user$project$View$validPath = '../UI/Image/md_check_box_green_24dp_1x.png';
var _user$project$View$validityIcon = function (validity) {
	var _p1 = validity;
	switch (_p1.ctor) {
		case 'Yes':
			return _user$project$View$validPath;
		case 'No':
			return _user$project$View$invalidPath;
		default:
			return _user$project$View$partialPath;
	}
};
var _user$project$View$ruleIcon = function (validity) {
	return A2(
...
var _user$project$View$ruleRow = function (passwordRule) {
	return A2(
		_elm_lang$html$Html$tr,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_user$project$View$ruleRowStyle)
			]),
		A2(
			_elm_lang$core$List$append,
			_elm_lang$core$Native_List.fromArray(
...
var _user$project$View$rulesDisplay = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			function (e) {
				return _user$project$View$ruleRow(e);
			},
			model.rules),
		_elm_lang$core$Native_List.fromArray(
			[]));
			...
			passwordRule,
			{
				validity: function () {
					var _p0 = A2(
						...
						password);
					if (_p0 === true) {
						return _user$project$Types$Yes;
					} else {
						return _user$project$Types$No;
					}
				}()
			});
	});
	...
	function (msg, model) {
		...
		return {
			...
			_0: _user$project$Update$updateModelValidity(
				A2(_user$project$Update$recalculateRules, _p1._0, model)),
