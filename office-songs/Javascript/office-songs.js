...
var _user$project$Page_Stats$getStatsForPerson = F2(
	function (model, person) {
		var numberPerPerson = A2(_user$project$Page_Stats$countPerPerson, person, model.allRequests);
		return {
			person: person,
...
var _user$project$Page_Stats$personCard = F2(
	function (model, person) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('grid-item stats-card-item'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Page_Stats$statCards = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (p) {
			return A2(_user$project$Page_Stats$personCard, model, p);
		},
		model.people);
};
var _user$project$Page_Stats$view = function (model) {
	return A2(
		...
		_user$project$Page_Stats$statCards(model));
};
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Song Requests'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
