...
var _user$project$Types$Flags = F2(
	function (a, b) {
		return {randomSeed: a, people: b};
	});
var _user$project$Types$Person = F3(
	function (a, b, c) {
		return {id: a, firstName: b, surname: c};
	});
var _user$project$Types$Pair = F2(
	function (a, b) {
		return {firstPerson: a, secondPerson: b};
	});
var _user$project$Types$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {people: a, nextPairs: b, currentPair: c, previousPairs: d, prohibitedPairIds: e, valid: f, randomSeed: g, currentUserState: h, debug: i};
	});
var _user$project$Types$ShowRecipient = {ctor: 'ShowRecipient'};
var _user$project$Types$ShowNewSanta = {ctor: 'ShowNewSanta'};
var _user$project$Types$NewRandom = function (a) {
	return {ctor: 'NewRandom', _0: a};
};
var _user$project$Types$Second = {ctor: 'Second'};
var _user$project$Types$First = {ctor: 'First'};
var _user$project$Types$Start = {ctor: 'Start'};
var _user$project$Types$Finished = {ctor: 'Finished'};
var _user$project$Types$SantaAndReciever = {ctor: 'SantaAndReciever'};
var _user$project$Types$NewSanta = {ctor: 'NewSanta'};

var _user$project$View$fullName = function (_p0) {
	var _p1 = _p0;
	return A2(
		F2(
			function (x, y) {
...
var _user$project$View$getName = F2(
	function (personOfPair, pair) {
		var _p2 = pair;
		if (_p2.ctor === 'Just') {
			var _p4 = _p2._0;
			var _p3 = personOfPair;
			if (_p3.ctor === 'First') {
				return _user$project$View$fullName(_p4.firstPerson);
			} else {
				return _user$project$View$fullName(_p4.secondPerson);
			}
		} else {
			return '';
		}
	});
var _user$project$View$interactionArea = function (model) {
	var _p5 = model.currentUserState;
	switch (_p5.ctor) {
		case 'NewSanta':
			return {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_user$project$View$getName, _user$project$Types$First, model.currentPair)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$ShowRecipient),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Show Who I Buy For'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			};
		case 'SantaAndReciever':
			return {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Buys for:'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_user$project$View$getName, _user$project$Types$Second, model.currentPair)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$ShowNewSanta),
										_1: {ctor: '[]'}
									}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Next Secret Santa'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$View$testTable = function (model) {
	return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_user$project$View$fullName(p.firstPerson)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_user$project$View$fullName(p.secondPerson)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$View$stylesheet = function (location) {
	var children = {ctor: '[]'};
	var attrs = {
		ctor: '::',
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'href', location),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _user$project$View$display = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('fond'),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'padding-top:350px;'),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			ctor: '::',
			_0: _user$project$View$stylesheet('../UI/CSS/SnowScene.css'),
			_1: {
				ctor: '::',
				_0: _user$project$View$stylesheet('../UI/CSS/Main.css'),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('contener_home_one'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fireplace'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fireplace_top'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('parallelogram'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('door'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('window_one'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('window_two'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('home_base'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('christmas_tree'),
																	_1: {ctor: '[]'}
																},
																{ctor: '[]'}),
															_1: {
																...
																_0: A2(
																	_elm_lang$html$Html$div,
																	{
																		...
																		_1: {
																			ctor: '::',
																			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'left:-140px;'),
																			_1: {ctor: '[]'}
																		}
																	},
																	{ctor: '[]'}),
																_1: {
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('mountain_one'),
																			_1: {ctor: '[]'}
																		},
																		{
																			ctor: '::',
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$class('sub_mountain_one'),
																					_1: {ctor: '[]'}
																				},
																				{
																					ctor: '::',
																	...
																	_1: {
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('mountain_two'),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
																				_0: A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$class('sub_mountain_two'),
																						_1: {ctor: '[]'}
																					},
																					{
																						ctor: '::',
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$class('lutz'),
																					_1: {ctor: '[]'}
																				},
																				{
																					ctor: '::',
																					_0: A2(
																						...
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html_Attributes$class('lutin_pom'),
																							_1: {ctor: '[]'}
																						},
																						{
																							ctor: '::',
																					...
																					_1: {
																						...
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$class('lutin_top'),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
																						...
																						_1: {
																							...
																							_0: A2(
																								...
																								{
																									ctor: '::',
																									_0: _elm_lang$html$Html_Attributes$class('lutin_head'),
																									_1: {ctor: '[]'}
																								},
																								{
																									ctor: '::',
																							...
																							_1: {
																								...
																								_0: A2(
																									...
																									{
																										ctor: '::',
																										_0: _elm_lang$html$Html_Attributes$class('lutin_arm1'),
																										_1: {ctor: '[]'}
																									},
																									{
																										ctor: '::',
																								...
																								_1: {
																									...
																									_0: A2(
																										...
																										{
																											ctor: '::',
																											_0: _elm_lang$html$Html_Attributes$class('lutin_arm2'),
																											_1: {ctor: '[]'}
																										},
																										{
																											ctor: '::',
																									...
																									_1: {
																										...
																										_0: A2(
																											...
																											{
																												ctor: '::',
																												_0: _elm_lang$html$Html_Attributes$class('lutin_body'),
																												_1: {ctor: '[]'}
																											},
																											{
																												ctor: '::',
																										...
																										_1: {
																											...
																											_0: A2(
																												...
																												{
																													ctor: '::',
																													_0: _elm_lang$html$Html_Attributes$class('lutin_jb1'),
																													_1: {ctor: '[]'}
																												},
																												{
																													ctor: '::',
																											...
																											_1: {
																												...
																												_0: A2(
																													...
																													{
																														ctor: '::',
																														_0: _elm_lang$html$Html_Attributes$class('lutin_jb2'),
																														_1: {ctor: '[]'}
																													},
																													{
																														ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('contener_snow'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('snowflakes'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('snowflake'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', ' width:500px;height:9px; background-color:#ffffff; border-radius:5px;'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'padding-top:10px;'),
										_1: {ctor: '[]'}
									},
									model.debug ? A2(
										_elm_lang$core$List$append,
										{
											ctor: '::',
											_0: _user$project$View$testTable(model),
											_1: {ctor: '[]'}
										},
										_user$project$View$interactionArea(model)) : _user$project$View$interactionArea(model)),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$View$view = function (model) {
	return _user$project$View$display(model);
};
...
var _user$project$Update$createPair = F2(
	function (personA, personB) {
		return {firstPerson: personA, secondPerson: personB};
	});
var _user$project$Update$getTail = function (list) {
...
var _user$project$Update$shiftPair = function (model) {
	var oldPair = model.currentPair;
	var pair = _elm_lang$core$List$head(model.nextPairs);
	var _p1 = oldPair;
	if (_p1.ctor === 'Just') {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				nextPairs: _user$project$Update$getTail(model.nextPairs),
				currentPair: pair,
				previousPairs: A2(
					_elm_lang$core$List$append,
					model.previousPairs,
		...
		return _elm_lang$core$Native_Utils.update(
			...
			{
				nextPairs: _user$project$Update$getTail(model.nextPairs),
				currentPair: _elm_lang$core$List$head(model.nextPairs)
			});
	}
};
var _user$project$Update$createPairs = F3(
	function (first, second, current) {
		createPairs:
		while (true) {
			if (_elm_lang$core$List$isEmpty(first) || _elm_lang$core$List$isEmpty(second)) {
				return current;
			} else {
				var _p2 = _elm_lang$core$List$head(first);
				if (_p2.ctor === 'Just') {
					var _p3 = _elm_lang$core$List$head(second);
					if (_p3.ctor === 'Just') {
						var _v4 = _user$project$Update$getTail(first),
							_v5 = _user$project$Update$getTail(second),
							_v6 = A2(
							_elm_lang$core$List$append,
							{
								ctor: '::',
								_0: A2(_user$project$Update$createPair, _p2._0, _p3._0),
								_1: {ctor: '[]'}
							},
							current);
						first = _v4;
...
var _user$project$Update$shufflePeople = F2(
	function (seed, people) {
		var second = _user$project$RandomUtil$shuffle(people);
		var first = _user$project$RandomUtil$shuffle(people);
		var tuple1 = A2(_elm_lang$core$Random$step, first, seed);
		var newSeed = _elm_lang$core$Tuple$second(tuple1);
		var tuple2 = A2(_elm_lang$core$Random$step, second, newSeed);
		var newPairs = A3(
			_user$project$Update$createPairs,
			_elm_lang$core$Tuple$first(tuple1),
			_elm_lang$core$Tuple$first(tuple2),
			{ctor: '[]'});
		return {
			ctor: '_Tuple2',
			_0: newPairs,
			_1: _elm_lang$core$Tuple$second(tuple2)
		};
	});
var _user$project$Update$allPairsCreated = function (model) {
	return _elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(model.nextPairs),
		_elm_lang$core$List$length(model.people)) > -1;
};
var _user$project$Update$prohibited = F2(
	function (tupleA, pairB) {
		var tupleB = {ctor: '_Tuple2', _0: pairB.firstPerson.id, _1: pairB.secondPerson.id};
		return _elm_lang$core$Native_Utils.eq(tupleA, tupleB);
	});
var _user$project$Update$pairProhibited = F2(
	function (model, pair) {
		return _elm_lang$core$List$isEmpty(model.prohibitedPairIds) ? false : A2(
			_elm_lang$core$List$any,
			function (p) {
				return A2(_user$project$Update$prohibited, p, pair);
			},
			model.prohibitedPairIds);
	});
var _user$project$Update$pairEqual = function (pair) {
	return _elm_lang$core$Native_Utils.eq(pair.firstPerson.id, pair.secondPerson.id);
};
var _user$project$Update$validPair = F2(
	function (model, pair) {
		return !(_user$project$Update$pairEqual(pair) || A2(_user$project$Update$pairProhibited, model, pair));
	});
var _user$project$Update$validPairs = function (model) {
	return A2(
		_elm_lang$core$List$all,
		function (p) {
			return A2(_user$project$Update$validPair, model, p);
		},
		model.nextPairs);
};
var _user$project$Update$validModel = function (model) {
	return _user$project$Update$validPairs(model);
};
var _user$project$Update$shuffleUntilValid = function (model) {
	shuffleUntilValid:
	while (true) {
		var shuffleResult = A2(_user$project$Update$shufflePeople, model.randomSeed, model.people);
		var newModel = _elm_lang$core$Native_Utils.update(
			model,
			{
				nextPairs: _elm_lang$core$Tuple$first(shuffleResult),
				randomSeed: _elm_lang$core$Tuple$second(shuffleResult)
			});
		if (_user$project$Update$allPairsCreated(model) && _user$project$Update$validModel(newModel)) {
			return _elm_lang$core$Native_Utils.update(
				newModel,
				{valid: true});
		} else {
			var _v7 = newModel;
			model = _v7;
			continue shuffleUntilValid;
		}
	}
};
var _user$project$Update$showRecipient = function (model) {
	var _p4 = model.currentUserState;
	switch (_p4.ctor) {
		case 'NewSanta':
			return _elm_lang$core$Native_Utils.update(
				model,
				{currentUserState: _user$project$Types$SantaAndReciever});
		case 'SantaAndReciever':
			return model;
		case 'Finished':
			return model;
...
var _user$project$Update$showNewSanta = function (model) {
	var _p5 = model.currentUserState;
	switch (_p5.ctor) {
		case 'NewSanta':
			return model;
		case 'SantaAndReciever':
			var _p6 = model.nextPairs;
			if (_p6.ctor === '[]') {
				return _elm_lang$core$Native_Utils.update(
					model,
					{currentUserState: _user$project$Types$Finished});
			} else {
				return _elm_lang$core$Native_Utils.update(
					model,
					{currentUserState: _user$project$Types$NewSanta});
			}
		case 'Finished':
			return model;
		default:
	...
	function (msg, model) {
		...
		switch (_p7.ctor) {
			case 'NewRandom':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Update$shuffleUntilValid(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								randomSeed: _elm_lang$core$Random$initialSeed(_p7._0)
							})),
			...
			case 'ShowNewSanta':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Update$shiftPair(
						_user$project$Update$showNewSanta(model)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: _user$project$Update$showRecipient(model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$States$initialModel = function (flags) {
	return {
		...
		nextPairs: {ctor: '[]'},
		currentPair: _elm_lang$core$Maybe$Nothing,
		previousPairs: {ctor: '[]'},
		valid: false,
		randomSeed: _elm_lang$core$Random$initialSeed(
			_elm_lang$core$Basics$round(flags.randomSeed)),
		currentUserState: _user$project$Types$Start,
		debug: false
	};
};
var _user$project$States$defaultModel = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Update$shuffleUntilValid(
			_user$project$States$initialModel(flags)),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
			...
			return A2(
				...
				function (randomSeed) {
					return _elm_lang$core$Json_Decode$succeed(
						{people: people, randomSeed: randomSeed});
				},
						...
						return A2(
							...
							function (id) {
								return A2(
									...
									function (surname) {
										return _elm_lang$core$Json_Decode$succeed(
											{firstName: firstName, id: id, surname: surname});
									},
									A2(_elm_lang$core$Json_Decode$field, 'surname', _elm_lang$core$Json_Decode$string));
							},
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Types.Msg","aliases":{},"unions":{"Types.Msg":{"tags":{"ShowRecipient":[],"ShowNewSanta":[],"NewRandom":["Int"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
